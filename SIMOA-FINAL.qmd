...
numeric_vars <- c("DBAS_Consequences", "DBAS_Worry_Helplessness", "DBAS_Expectations", "DBAS_Medications", 
                  "Extraversion", "Agreeableness", "Conscientiousness", "Neuroticism", "Openness", 
                  "SURPS_Impulsivity", "SURPS_Sensation_Seeking", "SURPS_Hopelessness", "SURPS_Anxiety_Sensitivity", 
                  "CISS_Avoidance_Style", "CISS_Task_Style", "CISS_Emotional_Style", "age")

# All variables to analyze (including categorical ones)
all_vars <- c(numeric_vars, "sex", "gender", "prov_terr", "education", "employment", "driving_freq", "income")
...
numeric_stats <- data.frame(
  ...
  Mean = round(sapply(analysis_dataset[numeric_vars], mean), 2),
  SD = round(sapply(analysis_dataset[numeric_vars], sd), 2)
)

print("NUMERIC VARIABLES:")
print(numeric_stats)

# Show frequency tables for categorical variables
categorical_vars <- c("sex", "gender", "prov_terr", "education", "employment", "driving_freq", "income")
print("CATEGORICAL VARIABLES:")
for(var in categorical_vars) {
  cat("\n", var, ":\n")
  print(table(analysis_dataset[[var]]))
}
```
